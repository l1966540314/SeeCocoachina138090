...
#define JBRouter  [JBMoudleRouter router]

#import <Foundation/Foundation.h>
#import <UIKit/UIKit.h>
#import "JBMoudleRouter.h"

typedef void(^JBCallBackBlock)(id parameter);
NS_ASSUME_NONNULL_BEGIN
#pragma mark -基础组件 这里可以定义一些公共的api和属性
@protocol JBMoudleProtocol <NSObject>
@optional;
//回调
@property (nonatomic, copy) JBCallBackBlock callbackBlock;
